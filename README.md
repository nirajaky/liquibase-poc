...
3. Then we created liquibase.properties with DB configuration and also, provided the path where the changelog should be triggered.
4. Then we can run-> mvn liquibase:update (It checks any liquibase and run for once)
